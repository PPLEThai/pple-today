// https://github.com/roninoss/rn-primitives/blob/main/packages/slot/src/slot.tsx
...
export const SlotTextInput = React.forwardRef<
  React.ElementRef<typeof RNTextInput>,
  RNTextInputProps
>((props, forwardedRef) => {
  const { children, ...textinputSlotProps } = props

  if (!React.isValidElement(children)) {
    console.log('Slot.TextInput - Invalid asChild element', children)
    return null
  }
  ...
  >(isTextChildren(children) ? <></> : children, {
    ...mergeProps(textinputSlotProps, children.props as AnyProps),
    ref: forwardedRef ? composeRefs(forwardedRef, (children as any).ref) : (children as any).ref,
  })
})

SlotTextInput.displayName = 'SlotTextInput'
