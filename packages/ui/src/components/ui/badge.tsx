  ...
  'web:inline-flex items-center rounded-full border border-border px-3 py-0.5 web:transition-colors web:focus:outline-none web:focus:ring-2 web:focus:ring-ring web:focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        closed:
          'border-transparent bg-base-secondary-light web:hover:opacity-80 active:bg-base-secondary-medium',
      },
    },
    defaultVariants: {
      variant: 'default',
...
const badgeTextVariants = cva('text-xs font-heading-semibold ', {
  variants: {
    variant: {
