...
function Input({
  ...
  return (
    <TextInput
      className={cn(
        'relative z-0 web:flex h-10 web:w-full rounded-md border border-input bg-background font-serif px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground web:ring-offset-background file:border-0 file:bg-transparent file:font-medium web:focus-visible:outline-none web:focus-visible:ring-2 web:focus-visible:ring-ring web:focus-visible:ring-offset-2',
