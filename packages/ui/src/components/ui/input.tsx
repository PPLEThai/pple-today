...
function Input({
  ...
  return (
    <TextInput
      className={cn(
        'relative z-0 web:flex h-10 web:w-full rounded-md border border-input bg-background px-3 py-2 text-[0.875rem] text-base-text-high font-heading-regular placeholder:text-muted-foreground web:ring-offset-background  web:focus-visible:outline-none web:focus-visible:ring-2 web:focus-visible:ring-ring web:focus-visible:ring-offset-2',
