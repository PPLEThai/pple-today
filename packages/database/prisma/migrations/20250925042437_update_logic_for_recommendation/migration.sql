DROP FUNCTION get_candidate_topic_by_follower (text);
...
DROP FUNCTION get_candidate_topic_by_interaction (text);
...
DROP FUNCTION get_candidate_topic_by_similar_hashtag (text);
...
DROP FUNCTION get_candidate_user_by_interaction (text);
...
DROP FUNCTION get_candidate_user_by_topic (text);
