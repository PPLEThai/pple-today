// https://github.com/bluesky-social/social-app/blob/1504ce28e2abf390955b1eb6e4d5742935c2055d/src/view/com/pager/Pager.tsx#L10
import { JSX, useCallback, useImperativeHandle, useRef, useState } from 'react'
...
export function Pager({
  ...
  return (
    ...
    //   dragState,
    // })}
    <AnimatedPagerView ref={pagerView} initialPage={initialPage} onPageScroll={handlePageScroll}>
      {children}
    </AnimatedPagerView>
  )
}
