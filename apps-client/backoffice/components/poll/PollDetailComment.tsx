...
interface PollDetailCommentsProps {
  feedItemComment: AdminFeedItemComment
  invalidate?: () => void
}

// TODO: This component diff only the type of the feedItemComment from the FeedDetailComment, please refactor it later
export const PollDetailComments = ({ feedItemComment, invalidate }: PollDetailCommentsProps) => {
