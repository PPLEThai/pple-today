              ...
              render={({ field: { onChange, value: _, ...field } }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      type="file"
                      className="p-0 pr-3 file:px-3 file:py-2 file:mr-3 file:border-0 file:border-solid file:border-r file:border-r-input file:h-10 file:bg-secondary file:hover:opacity-80 file:active:opacity-80 file:text-secondary-foreground file:cursor-pointer file:font-medium"
                      {...field}
