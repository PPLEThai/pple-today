...
- [#481](https://github.com/PPLEThai/pple-today/pull/481) [`0e2b629`](https://github.com/PPLEThai/pple-today/commit/0e2b629ab66adbe7cc04adf973acc09c701b06a5) Thanks [@PanJ](https://github.com/PanJ)! - Let an admin add a notification key to a Builder App without an audience limit.
  ...
  (`ADMIN` | `PLATFORM`). `miniAppId` answers _attribution_ — whose name and icon
  the notification wears — and `source` answers _capability_ — what the key may ask
...
- Updated dependencies [[`0e2b629`](https://github.com/PPLEThai/pple-today/commit/0e2b629ab66adbe7cc04adf973acc09c701b06a5)]:
  - @pple-today/database@1.11.0
  - @pple-today/api-common@1.12.0
...
- [#476](https://github.com/PPLEThai/pple-today/pull/476) [`8cbea16`](https://github.com/PPLEThai/pple-today/commit/8cbea16e73d7b86fd95898f8a7faec26605402ed) Thanks [@PanJ](https://github.com/PanJ)! - Run the API images on bun instead of node.
...
- Updated dependencies [[`7ad7b64`](https://github.com/PPLEThai/pple-today/commit/7ad7b645c956419323206d48c3f87e13f83d2cb3)]:
  - @pple-today/database@1.10.3
...
- [#462](https://github.com/PPLEThai/pple-today/pull/462) [`063a932`](https://github.com/PPLEThai/pple-today/commit/063a9329e0f487a8514dcacdd4569f2a62e96c69) Thanks [@PanJ](https://github.com/PanJ)! - Let an app-bound `NotificationApiKey` name its recipients on `POST /external/notifications`.
...
- Updated dependencies [[`063a932`](https://github.com/PPLEThai/pple-today/commit/063a9329e0f487a8514dcacdd4569f2a62e96c69)]:
  - @pple-today/api-common@1.11.0
  - @pple-today/database@1.10.0
...
- [#457](https://github.com/PPLEThai/pple-today/pull/457) [`530a6c7`](https://github.com/PPLEThai/pple-today/commit/530a6c7cd974197aaee359539022fa5b379228de) Thanks [@PanJ](https://github.com/PanJ)! - Add `GET /external/notifications/app-install`, which answers whether PPLE Today reaches the phone behind a number, so a caller can tell someone who is missing notifications what to do about it.
...
- [#451](https://github.com/PPLEThai/pple-today/pull/451) [`2aedc8d`](https://github.com/PPLEThai/pple-today/commit/2aedc8d1756b33dee915abd82d4515ff2d63bbd5) Thanks [@PanJ](https://github.com/PanJ)! - Ask, rather than refuse, when a mini-app link falls outside your บทบาท

  - Opening a published mini app whose role list does not cover your active role used to dead-end on "เกิดข้อผิดพลาดในการยืนยันตัวตน" and a not-found screen. The role list is a _listing_ filter — it decides whose app grid shows the app — and every mini app authorises its own routes anyway, so this is now a question: `กำลังเข้าสู่แอปฯ "{ชื่อแอป}"`, with ยกเลิก and เข้าใช้งาน.
...
- [#449](https://github.com/PPLEThai/pple-today/pull/449) [`dcb2d51`](https://github.com/PPLEThai/pple-today/commit/dcb2d51f31065a1ce9f094aaba1af2d268deb274) Thanks [@PanJ](https://github.com/PanJ)! - Badge the app icon from the push, so the count is right while the app is closed
...
- [#447](https://github.com/PPLEThai/pple-today/pull/447) [`305550b`](https://github.com/PPLEThai/pple-today/commit/305550bf4bee5a52beda11737039e333dfe46c99) Thanks [@PanJ](https://github.com/PanJ)! - Report a notification quota only for the apps held to one
...
- Updated dependencies [[`1ce490d`](https://github.com/PPLEThai/pple-today/commit/1ce490d8c3d7617cde68f50e7549dc31ad6a8949)]:
  - @pple-today/database@1.8.0
  - @pple-today/api-common@1.7.0

## 1.11.0

### Minor Changes

- [#428](https://github.com/PPLEThai/pple-today/pull/428) [`57cd7c7`](https://github.com/PPLEThai/pple-today/commit/57cd7c72a8897ae1831d87f446bc6629b37fbfd3) Thanks [@PanJ](https://github.com/PanJ)! - Surface the Beta invite accept/decline inbox from the notification centre instead of a dead-end message.
...
- Updated dependencies [[`57cd7c7`](https://github.com/PPLEThai/pple-today/commit/57cd7c72a8897ae1831d87f446bc6629b37fbfd3)]:
  - @pple-today/database@1.7.0
  - @pple-today/api-common@1.6.1

## 1.10.0

### Minor Changes

- [#426](https://github.com/PPLEThai/pple-today/pull/426) [`7b2634b`](https://github.com/PPLEThai/pple-today/commit/7b2634b498b18f10303e9b285e3b01c2c0beb6fa) Thanks [@PanJ](https://github.com/PanJ)! - Expose today's notification send count for the platform Console Usage tile
...
- [#423](https://github.com/PPLEThai/pple-today/pull/423) [`394226c`](https://github.com/PPLEThai/pple-today/commit/394226c7925b4661dac1062424cd00d499b9b651) Thanks [@PanJ](https://github.com/PanJ)! - Make the Beta invite seat cap atomic under concurrency
...
- [#424](https://github.com/PPLEThai/pple-today/pull/424) [`a89a50d`](https://github.com/PPLEThai/pple-today/commit/a89a50d570f74dccb6b9ed86d7821c242b869be4) Thanks [@PanJ](https://github.com/PanJ)! - Make the notification daily quota atomic under concurrency
...
- [#422](https://github.com/PPLEThai/pple-today/pull/422) [`c38503b`](https://github.com/PPLEThai/pple-today/commit/c38503bcb5931339456158b7b45d25b1d8daff31) Thanks [@PanJ](https://github.com/PanJ)! - Tier-gate mini-app token exchange for Draft/Beta apps
...
- Updated dependencies [[`f8efa12`](https://github.com/PPLEThai/pple-today/commit/f8efa127fcb1695f162723f71dc6c8d9fcb5db35), [`d4ca97d`](https://github.com/PPLEThai/pple-today/commit/d4ca97d7fedda067ce9a00ca8ae8612158a247f4), [`54f98b6`](https://github.com/PPLEThai/pple-today/commit/54f98b6c604e450f638b7d991e794f57bf1a353a), [`c9b2a51`](https://github.com/PPLEThai/pple-today/commit/c9b2a51ad180be1a857f40c8ad8290db7d073507), [`e2da97d`](https://github.com/PPLEThai/pple-today/commit/e2da97d3b7f7b5ead26c7734a555fc7ba97359ca), [`2d33915`](https://github.com/PPLEThai/pple-today/commit/2d33915790a69c38c52ebd46c88b3629046ca703)]:
...
- [#412](https://github.com/PPLEThai/pple-today/pull/412) [`9172ee6`](https://github.com/PPLEThai/pple-today/commit/9172ee6c144d7113fd9606bf8b357479b2d68512) Thanks [@PanJ](https://github.com/PanJ)! - Tier-aware mini app listing for Builder Apps
...
- Updated dependencies [[`9172ee6`](https://github.com/PPLEThai/pple-today/commit/9172ee6c144d7113fd9606bf8b357479b2d68512)]:
...
- [#406](https://github.com/PPLEThai/pple-today/pull/406) [`2eb8ced`](https://github.com/PPLEThai/pple-today/commit/2eb8ced8a487df125ec175e0d5f03ef0b35e891c) Thanks [@PanJ](https://github.com/PanJ)! - Zitadel app management and API-driven role options in Today Admin
...
- Updated dependencies [[`2eb8ced`](https://github.com/PPLEThai/pple-today/commit/2eb8ced8a487df125ec175e0d5f03ef0b35e891c)]:
  - @pple-today/api-common@1.4.1

## 1.7.0

### Minor Changes

- [#404](https://github.com/PPLEThai/pple-today/pull/404) [`fcfdcec`](https://github.com/PPLEThai/pple-today/commit/fcfdcec4f102c8fe8555d6117c50f1caf5c89a3a) Thanks [@PanJ](https://github.com/PanJ)! - Manage mini apps in one place from Today Admin
...
- Updated dependencies [[`fcfdcec`](https://github.com/PPLEThai/pple-today/commit/fcfdcec4f102c8fe8555d6117c50f1caf5c89a3a)]:
  - @pple-today/api-common@1.4.0
  - @pple-today/database@1.4.0
...
- Updated dependencies [[`3ae4afd`](https://github.com/PPLEThai/pple-today/commit/3ae4afd12312ee50488388ffd2b02ca7f4083166), [`b50520b`](https://github.com/PPLEThai/pple-today/commit/b50520b773dc826981a1d85ec629ed01f3a6d1a1)]:
  - @pple-today/api-common@1.3.6
  - @pple-today/database@1.3.2
...
- Updated dependencies [[`8f8b4d6`](https://github.com/PPLEThai/pple-today/commit/8f8b4d6f5de1b388dd3b6d6bc9a725da4bd88d3b), [`8e02350`](https://github.com/PPLEThai/pple-today/commit/8e023504e087db778097d148266d5a2b2f6a1632)]:
  - @pple-today/api-common@1.3.5
...
- Updated dependencies [[`e014f92`](https://github.com/PPLEThai/pple-today/commit/e014f92bb07792b8b68d5bd3e3a3763f957ae01d)]:
  - @pple-today/api-common@1.0.0
  - @pple-today/database@1.0.0
...
- [#177](https://github.com/PPLEThai/pple-today/pull/177) [`cb162c6`](https://github.com/PPLEThai/pple-today/commit/cb162c66e287a7bb5d548fdac1bee2fc8aa689e7) Thanks [@miello](https://github.com/miello)! - [[PPLE-439] [API] Search module type error](https://linear.app/snts/issue/PPLE-439/api-search-module-type-error)

- [#157](https://github.com/PPLEThai/pple-today/pull/157) [`b91d520`](https://github.com/PPLEThai/pple-today/commit/b91d5201f275daf627ca150f1c5b1a2d04edf0ad) Thanks [@miello](https://github.com/miello)! - [[PPLE-405] [API] Remove official constraint when get feed item details page](https://linear.app/snts/issue/PPLE-405/api-remove-official-constraint-when-get-feed-item-details-page)
...
- [#176](https://github.com/PPLEThai/pple-today/pull/176) [`4d3083c`](https://github.com/PPLEThai/pple-today/commit/4d3083c51e6e58a061966ac860f3b7b21ac16e04) Thanks [@TeeGoood](https://github.com/TeeGoood)! - [[PPLE-431] [API] Election Result Score](https://linear.app/snts/issue/PPLE-431/api-election-result-score)
